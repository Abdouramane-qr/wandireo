export function buildAdminFrTranslations(): Record<string, string> {
    return {
        ...
        "admin.blog.editor.placeholder.preview": "La prévisualisation s'affichera ici...",
        ...
        "admin.blog.editor.validate_error": "Veuillez vérifier les erreurs du formulaire.",
        ...
        "admin.reviews.update_error": "Erreur lors de la mise à jour de l'avis.",
        ...
        "admin.users.error.pdf_required": "Veuillez sélectionner un fichier PDF.",
        ...
        "admin.services.fareharbor.catalog_note": "Service synchronisé via FareHarbor",
        ...
        "admin.structure.select_category_manage": "Sélectionnez une catégorie pour gérer sa structure.",
        ...
        "admin.structure.placeholder.options": "Exemple : automatique:auto, manuel:manual",
        ...
        "admin.structure.confirm.delete_category": "Supprimer cette catégorie ? Cela affectera les services liés.",
        "admin.structure.confirm.delete_subcategory": "Supprimer cette sous-catégorie ?",
        ...
        "admin.structure.toast.category_save_error": "Erreur lors de l'enregistrement de la catégorie.",
        ...
        "admin.structure.toast.attributes_added": "Attributs ajoutés avec succès.",
        "admin.structure.toast.attribute_save_error": "Erreur lors de l'enregistrement de l'attribut.",
        ...
        "admin.structure.error.select_category": "Veuillez sélectionner une catégorie.",
        "admin.structure.error.attributes_exist": "Certains attributs existent déjà.",
        "admin.structure.error.attributes_add": "Erreur lors de l'ajout des attributs.",
        "admin.structure.error.extras_exist": "Certaines options existent déjà.",
        "admin.structure.error.extras_add": "Erreur lors de l'ajout des options.",
        "admin.structure.error.preset_apply": "Erreur lors de l'application du preset.",
        "admin.structure.error.preset_exists": "Le preset a déjà été appliqué.",
        "admin.structure.error.no_attribute_preset": "Aucun preset d'attribut disponible.",
        "admin.structure.error.no_extra_preset": "Aucun preset d'option disponible.",

        // Presets Specifics
        "admin.structure.preset.boats": "Appliquer preset Bateaux",
        "admin.structure.preset.boats_created": "Structure Bateaux initialisée.",
        "admin.structure.preset.cars": "Appliquer preset Voitures",
        "admin.structure.preset.cars_created": "Structure Voitures initialisée.",
        "admin.structure.preset.stays": "Appliquer preset Hébergements",
        "admin.structure.preset.stays_created": "Structure Hébergements initialisée.",

        "admin.structure.preset.boat_category.name": "Bateaux",
        "admin.structure.preset.boat_category.description": "Locations de bateaux, excursions maritimes et jet-skis.",
        ...
        "admin.structure.preset.boat_subcategory.rental_with_or_without_license": "Location avec ou sans permis",

        "admin.structure.preset.car_category.name": "Voitures",
        "admin.structure.preset.car_category.description": "Location de véhicules et mobilité locale.",
        ...
        "admin.structure.preset.stay_category.description": "Villas, appartements et séjours premium.",
        ...
        "admin.structure.preset.attribute.car.air_conditioning": "Climatisation",
        ...
        "admin.structure.preset.extra.boat.skipper.description": "Accompagnement par un skipper professionnel.",
        "admin.structure.preset.extra.boat.fuel.name": "Forfait carburant",
        "admin.structure.preset.extra.boat.fuel.description": "Forfait carburant appliqué à la réservation.",
        "admin.structure.preset.extra.boat.towels.name": "Serviettes",
        "admin.structure.preset.extra.boat.towels.description": "Serviettes disponibles à bord.",
        "admin.structure.preset.extra.car.child_seat.name": "Siège enfant",
        "admin.structure.preset.extra.car.child_seat.description": "Siège enfant installé dans le véhicule.",
        "admin.structure.preset.extra.car.driver.name": "Chauffeur",
        "admin.structure.preset.extra.car.driver.description": "Service chauffeur pour le trajet.",
        "admin.structure.preset.extra.car.delivery.name": "Livraison à l'hôtel",
        "admin.structure.preset.extra.car.delivery.description": "Livraison du véhicule à l'hôtel du client.",
        "admin.structure.preset.extra.stay.breakfast.name": "Petit-déjeuner",
        "admin.structure.preset.extra.stay.breakfast.description": "Petit-déjeuner ajouté au séjour.",
        "admin.structure.preset.extra.stay.late_checkout.name": "Late check-out",
        "admin.structure.preset.extra.stay.late_checkout.description": "Départ tardif selon disponibilité.",
        "admin.structure.preset.extra.stay.final_cleaning.name": "Nettoyage final",
        "admin.structure.preset.extra.stay.final_cleaning.description": "Frais de nettoyage en fin de séjour.",
        ...
        "admin.transactions.formula_label": "Comment la commission est calculée",
        ...
        "admin.dashboard.metric.commissions_sub": "Sur {count} réservation(s) confirmée(s)",
        "admin.dashboard.metric.pending": "En attente",
        "admin.dashboard.metric.pending_sub": "Réservation(s) en cours de traitement",
        "admin.dashboard.metric.accounts": "Comptes actifs",
        "admin.dashboard.metric.accounts_sub": "{clients} client(s) · {partners} partenaire(s)",
        "admin.dashboard.metric.catalog": "Catalogue actif",
        "admin.dashboard.metric.catalog_sub": "{partners} partenaire(s) valides · {reviews} avis en attente",
        ...
        "support.subtitle": "Pilotez l'assistance utilisateur et suivez les incidents Wandireo.",
        ...
        "support.form.subtitle": "Remplissez les détails ci-dessous pour créer une demande d'assistance.",
        "support.form.subject_placeholder": "Ex: Problème d'accès ou erreur technique",
        "support.form.message_placeholder": "Décrivez votre demande en quelques lignes...",
        "support.form.media_placeholder": "Lien optionnel (Loom, Screenshot...)",
        "support.form.submit": "Créer le ticket",
        "support.toast.create_success": "Le ticket a été créé avec succès.",
        "support.toast.create_error": "Veuillez remplir les champs obligatoires.",
        "support.toast.status_success": "Statut mis à jour.",
        "support.toast.status_error": "Erreur lors de la mise à jour du statut.",
        "support.toast.priority_success": "Priorité mise à jour.",
        "support.toast.priority_error": "Erreur lors de la mise à jour de la priorité.",

        // Missing structure toasts
        "admin.structure.toast.extra_save_error": "Erreur lors de l'enregistrement de l'option.",
        "admin.structure.toast.subcategory_created": "Sous-catégorie créée.",
        "admin.structure.toast.subcategory_updated": "Sous-catégorie mise à jour.",
        "admin.structure.toast.subcategory_deleted": "Sous-catégorie supprimée.",
        "admin.structure.toast.subcategory_save_error": "Erreur lors de l'enregistrement de la sous-catégorie.",
    };
}
